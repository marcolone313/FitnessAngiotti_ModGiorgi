...
import { ClienteService, RestCliente } from './cliente.service';

const requireRestSample: RestCliente = {
  ...sampleWithRequiredData,
  dataDiNascita: sampleWithRequiredData.dataDiNascita?.format(DATE_FORMAT),
};
