...
import { sampleWithRequiredData } from '../esercizio.test-samples';
import { EsercizioService } from '../service/esercizio.service';

import { EsercizioComponent } from './esercizio.component';
import SpyInstance = jest.SpyInstance;

describe('Esercizio Management Component', () => {
  let comp: EsercizioComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EsercizioComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.esercizios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to esercizioService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEsercizioIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEsercizioIdentifier).toHaveBeenCalledWith(entity);
